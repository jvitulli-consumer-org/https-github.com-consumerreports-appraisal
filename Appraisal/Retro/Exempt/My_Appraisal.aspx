<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="My_Appraisal.aspx.vb" Inherits="Appraisal.My_Appraisal"  MaintainScrollPositionOnPostback="true" ValidateRequest="false"%>
    ...
    <tr><td>
         <table border="0" style="width:100%">
           ...
           <tr><td class="style4"><b>Title:</b></td>
               ...
               <td style="text-align:right; width:100px">Approved:&nbsp;&nbsp;</td>
           ...
           <tr><td class="style4"><strong>Department:</strong></td>
               ...
               <td style="text-align:right;">Approved:&nbsp;&nbsp;</td><td><asp:Label ID="LblSec_Mgr_Appr" runat="server" Text="" Font-Names="Calibri" /></td></tr>
           <tr><td class="style4"><strong>Hire Date:</strong></td>
               ...
               <td  style="text-align:right;">Approved:&nbsp;&nbsp;</td><td><asp:Label ID="LblHR_Appr" runat="server" Text="" Font-Names="Calibri" /></td></tr>
           </table>
...
<asp:Panel ID="Panel_Goal1" Visible="true" runat="server">
    <tr><td style="font-size:large; font-weight:bold; color: #00ae4d; font-family:Calibri;" colspan="2"><u>Accomplishments:</u><span class="style13"><u>(Summarize accomplishments vs the goals/expectations established for FY<asp:Label ID="LblCur_Year1" runat="server" Text="" Font-Names="Calibri" />)</u></span></td></tr>
    <tr><td style="width:98%; font-family:Calibri;"><asp:Label ID="Goals_1" runat="server" Visible="false"/><%=Goals_1.Text%></td></tr>
</asp:Panel>
<!--
<asp:Panel ID="Panel_Goal2" Visible="false" runat="server"><tr><td style="vertical-align:top; text-align:center; font-weight:bold;">2)</td><td><asp:Label ID="Goals_2" runat="server"/></td></tr></asp:Panel>       
<asp:Panel ID="Panel_Goal3" Visible="false" runat="server"><tr><td style="vertical-align:top; text-align:center; font-weight:bold;">3)</td><td><asp:Label ID="Goals_3" runat="server"/></td></tr></asp:Panel> 
<asp:Panel ID="Panel_Goal4" Visible="false" runat="server"><tr><td style="vertical-align:top; text-align:center; font-weight:bold;">4)</td><td><asp:Label ID="Goals_4" runat="server"/></td></tr></asp:Panel> 
<asp:Panel ID="Panel_Goal5" Visible="false" runat="server"><tr><td style="vertical-align:top; text-align:center; font-weight:bold;">5)</td><td><asp:Label ID="Goals_5" runat="server"/></td></tr></asp:Panel> 
-->
 </table>
</td></tr>
...
<asp:Panel ID="Panel_Development" Visible="true" runat="server">   
    ...
    <tr><td style="font-family:Calibri;"><asp:Label ID="Development" runat="server" Visible="false"/><%=Development.Text%></td></tr>
</asp:Panel>
<!--3. END Delepopment-->   
...
<asp:Panel ID="Panel_OveallRating" Visible="true" runat="server">
   ...
   <tr><td><table id="OVER" border="1" style="width:100%; text-align:center; font-weight:bold; border-spacing:0;" runat="server">
...
<asp:Panel ID="Panel_Summary" Visible="true" runat="server"> 
    ...
    <tr><td style="font-family:Calibri;"><asp:Label ID="OverAll_Sum" runat="server" Visible="false"/><%=OverAll_Sum.Text%></td></tr>
</asp:Panel>
...
<tr><td class="BorderColor" style="vertical-align:top; text-align:center; font-weight:bold;">10)</td>
    ...
    <td class="BorderColor" style="vertical-align:top;"><asp:Label ID="FUT_Succ_10" runat="server" Visible="false"/><%=FUT_Succ_10.Text%></td>
...
<table border="1" style="width:100%; text-align:center; border-color: #00ae4d; border-collapse:collapse; border-spacing:0;" runat="server">
    ...
    <tr style="height:33px; font-size:large">
        <td rowspan="5" class="style10 BorderColor"><img alt="images/leading.png" src="images/leading.png" /></td>
    ...
    <tr style="height:33px; font-size:large">
        <td class="BorderColor style11">Translate Vision into Action</td>
    ...
    <tr style="height:33px; font-size:large">
        <td rowspan="4" class="style10 BorderColor"><img alt="images/leading2.png" src="images/leading2.png" /></td>
    ...
    <tr style="height:33px; font-size:large"><td rowspan="3" class="style10 BorderColor"><img alt="images/leading3.png" src="images/leading3.png" /></td>
...
<tr><td>
<table style="width:100%"><tr><td style="width:30%" ></td><td>

<div id="divCalendar" style="position: absolute;">
<asp:Calendar id="Calendar1" runat="server" BorderWidth="1px" BackColor="White" Width="200px" ForeColor="Black" Height="180px" Font-Size="11pt" Font-Names="Verdana"  Visible="false"
...
<asp:Panel ID="E_Singed" runat="server" Visible="false">
<tr><td colspan="3"><u style="color: #00ae4d; font-size:large; font-weight:bold; font-family:Calibri;">Signature:</u>&nbsp;(Employees are expected to sign below indicating they have read this appraisal and discussed its contents with their manager. 
    The employee’s signature does not signify agreement with the appraisal. Employees who wish to comment on the appraisal may do so by attaching comments to the printed appraisal.)</td></tr>

<tr><td style="text-align:center; font-weight:bold; vertical-align: middle; color:blue; font-family:Calibri;" colspan="3">Met with supervisor on <asp:TextBox ID="txtCal" runat="server" Width="70px" 
    BorderStyle="Solid" Font-Names="Calibri" BorderColor="#E7E8E3" Visible="true" ReadOnly="true"/><asp:ImageButton ID="imgCal" runat="server" ImageUrl="../../Images/calendar.png" Visible="true" /></td></tr>
  <tr><td style="text-align:center;" colspan="3">&nbsp;</td></tr>
  <tr><td style="text-align:center;" colspan="3">
      <asp:Button ID="Esign" runat="server" Text="E-Signature" BackColor="Wheat" BorderStyle="None" Font-Size="12pt" ForeColor="Blue" Font-Names="Calibri" Visible="false"/>&nbsp;</td></tr>
</asp:Panel>

<tr><td style="text-align:center;">&nbsp;</td></tr>
<tr><td style="text-align:center;"><!--<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../../Images/Back_button.png" style="width:90px" />-->
