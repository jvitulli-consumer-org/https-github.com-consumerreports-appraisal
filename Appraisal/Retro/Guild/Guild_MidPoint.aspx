<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Guild_MidPoint.aspx.vb" Inherits="Appraisal.Guild_MidPoint" %>
...
<table border="0" style="width:100%">
    ...
    <tr><td colspan="6" class="Style1"><u>FY16 Mid Point Conversation Acknowledgement</u></td></tr>
...
<!--<tr><td></td><td></td><td></td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>-->
    ...
    <tr><td>&nbsp;&nbsp;</td><td style="height:60px; vertical-align:middle;">

        <asp:CheckBox ID="CheckBox_Met" runat="server" class="mycheckBig" AutoPostBack="true" OnCheckedChanged="Confirm_CheckedChanged" Visible="true"/>
...
<table id="tblSelectDate" border="0" style="height:70px;" runat="server">
    <tr style="vertical-align:middle;" ><td class="auto-style1" >I confirm that <strong>I have met</strong> with my manager to have a mid point performance conversation on .</td>
        <td style="vertical-align:middle;"><asp:Panel ID="Cal_Mgr" runat="server">
...
<asp:Panel ID="Panel_NotMet" runat="server" Visible="false">
    <tr><td>&nbsp;&nbsp;</td><td style="height:80px;vertical-align:middle;">
        <asp:CheckBox ID="CheckBox_NotMet" runat="server" class="mycheckBig"  AutoPostBack="true" OnCheckedChanged="Confirm_CheckedChanged1"/>
             <img id="CheckImg1" runat="server" alt="../../images/CheckRed1.png" src="../../images/CheckGreen.png" Visible="false" />
             <img id="CheckBlank1" runat="server" alt="../../images/CheckBlank.png" src="../../images/CheckBlank.png" Visible="false" />
       </td><td colspan="3" style="font-size:large; font-family:Calibri"><strong>I have not met</strong> with my manager to have a mid point performance conversation. <asp:Label ID="lblDate1" runat="server"/></td><td></td></tr>
</asp:Panel>    
<!-- <tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>-->

<asp:Panel ID="Com" runat="server">
<tr><td>&nbsp;&nbsp;</td><td colspan="4"><div style="font-size:small; font-family:Calibri; color:gray;">Comments <i>(optional)</i>:</div>
    <asp:TextBox ID="Comments" runat="server" Width="99%" TextMode="MultiLine" Rows="5" style="overflow:auto; border-color:gray; font-family:Calibri;" ValidateRequestMode="Disabled" /></td><td>&nbsp;&nbsp;</td></tr>
</asp:Panel>
...
<tr><td>&nbsp;&nbsp;</td>
    ...
    <tr><td colspan="6" style="text-align:center;">
        <asp:Button ID="Button1" Text="Close" runat="server" style="border-style:none; color:Blue; width:120px; font-weight:bold; cursor: pointer;" 
            CssClass="Button_StyleSheet" OnClientClick="javascript:window.open('','_self',''); window.close(); return false;" Visible="false"/>
