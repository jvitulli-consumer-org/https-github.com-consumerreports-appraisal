<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GuildReview.aspx.vb" Inherits="Appraisal.GuildReview" %>
...
<table class="Style0" border="0">
   <tr><td class="Style3">&nbsp;</td>
       <td colspan="3" class="Style1"><img alt="../../images/CR_logo.png" src="../../images/CR_logo.png" style="width: 380px; height:60px" /></td>
       <td class="Style3">&nbsp;</td></tr> 
   <tr><td class="Style3">&nbsp;</td>
       <td colspan="3" class="Style1" style="color: #00ae4d;"><u>Performance Appraisal</u></td>
       <td class="Style3">&nbsp;</td></tr> 
    <tr><td class="Style3">&nbsp;</td>
        <td colspan="3" class="Style11">October 1, <%=Session("Prev_Year")%>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;September 30, <%=Session("Cur_Year")%></td>
        <td class="Style3">&nbsp;</td></tr> 
    <tr><td class="Style3">&nbsp;</td>
        <td colspan="3">
      <table class="Style0" border="0">
      ...
      <td class="Style3">&nbsp;</td></tr> 
  <tr><td class="Style3"></td><td colspan="3">


<asp:Panel ID="Panel11" runat="server" Visible="true" Width="100%"><font color="#00ae4d"><b><u>Key Tasks:</u></b></font>&nbsp;<i>
Enter in the Key Task and description information in the space provided below. Key Task information should be extracted from employee&#39;s job description. 
...
<!--<tr><td class="Style3">&nbsp;</td><td colspan="3">&nbsp;</td><td class="Style3">&nbsp;</td></tr>-->
...
<tr><td>&nbsp;&nbsp;</td>
    <td><b>Comments:</b>&nbsp;&nbsp;<asp:Label ID="TaskComments10" runat="server"/><%=TaskComments10.Text%></td></tr>
<tr><td style="font-size:1px;">&nbsp;&nbsp;</td><td style="background-color: gray; font-size:1px; height:1px;">&nbsp;</td></tr>
<!--<tr><td style="font-size:xx-small;">&nbsp;</td><td style="font-size:xx-small;">&nbsp;&nbsp;</td></tr>-->
</table> 
...
<table class="Style0" border="0">
<asp:Panel ID="Panel21" runat="server" Visible="true">
...
<asp:Panel ID="Panel22" runat="server">
 <table class="Style0" border="0">
     <tr><td><font color="#00ae4d"><b><u>Manager's Overall Peformance Comments:</u></b></font>&nbsp;&nbsp;<asp:Label ID="SuperComments" runat="server" Visible="false"/><%=SuperComments.Text%></td></tr>
</table>
</asp:Panel>
</td>
<td></td></tr>
...
<tr><td>&nbsp;&nbsp;</td>
    <td>
 <table class="Style0" border="0">
   <tr><td style="font-size:1px; height:1px; background-color:Gray;">&nbsp;</td></tr>
   ...
   <tr><td>
        <table width="100%" border="1" cellpadding="1" cellspacing="0" style="border-color:black; border-style:solid;">
           ...
           <tr><td valign="top"><asp:Label ID="SuperComments1" runat="server" Width="99%" CssClass="Label_StyleSheet"/></td>
               ...
               <td valign="top"><asp:Label ID="SuperComments3" runat="server" Width="99%" CssClass="Label_StyleSheet"/></td></tr></table>
    </td></tr>
<tr><td style="font-size:1px; height:1px; background-color:Gray;">&nbsp;</td></tr>
</table>
...
<!--<tr><td>&nbsp;</td>
<td style="font-size:large; font-weight:bold; text-align:center;"><br/>
Pressing the submit button means that I have reviewed and discussed this appraisal with my immediate supervisor.<br/><br/>
It does not necessarily imply that I agree with this evaluation.<br/><br/></td><td>&nbsp;</td></tr>-->

<!--<tr><td>&nbsp;</td><td>
     
<table width="100%" border="1"><tr><td valign="top" class="auto-style3"><b>Employee&#39;s Comments:&nbsp;</b></td>
               <td valign="top">
<asp:UpdatePanel ID="UpdatePanel_GuildComments" runat="server" UpdateMode="Conditional">
<ContentTemplate>                   
<asp:TextBox ID="GuildComments" runat="server" Width="99%" TextMode="MultiLine" Borderstyle="Solid" BorderColor="LightGray" Rows="3" class="TextBox_StyleSheet" Style="overflow:auto;" AutoPostBack="True"/>
</ContentTemplate>
    <triggers>
        <asp:AsyncPostBackTrigger ControlID="GuildComments" EventName="TextChanged" />
    </triggers>
    </asp:UpdatePanel> 
...
<asp:button id="GLD_Submit" runat="server" Text="Submit" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" width="120px" CssClass="Label_StyleSheet" />
<asp:Label ID="LblGuild_Submitted" runat="server" text=""/></td><td>&nbsp;</td></tr>
<tr><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td></tr>
<tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>

<tr><td class="Style1" colspan="3"><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../../Images/Back_button.png" style="width:90px" />    </td></tr>
</table>
</div>
