<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Goals.aspx.vb" Inherits="Appraisal.Goals" MaintainScrollPositionOnPostback="true" smartNavigation="true"%>
...
<table class="Style0" border="0">
  <tr><td class="style6">&nbsp;</td><td class="Style1"><img alt="../../images/CR_logo.png" src="../../images/CR_logo.png" style="width: 380px; height:60px" /></td>
        ...
        <td class="style6" rowspan="4">
            <asp:Button ID="lblMessage1" runat="server" ForeColor="Green" BackColor="White" BorderStyle="None" Font-Bold="true" Font-Size="12px" Width="100px" Text="" CssClass="Button_StyleSheet;" style="position:fixed;"/><br />
