<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FutureGoals1.aspx.vb" Inherits="Appraisal.FutureGoals1" %>
...
<table class="Style0" border="0">
  ...
  <tr><!--<td class="style6">&nbsp;</td>--><td>
      <table style="width:100%" border="0" class="TextBox_StyleSheet">
            <tr><td style="font-family: Calibri;" class="auto-style2"><b>Name:</b></td>
                <td class="auto-style3"><asp:label id="lblEmpl_NAME" runat="server" CssClass="Label_StyleSheet"/></td>
                <td class="auto-style4">&nbsp;&nbsp;</td>
                <td class="auto-style5">&nbsp;&nbsp;</td>
                <td style="font-family: Calibri;" class="auto-style6"><asp:Label ID="LblEsign" runat="server" Text="E-Signed:"/></asp:Label>&nbsp;&nbsp;</td>
                <td class="auto-style7"><asp:Label ID="LblEMP_Appr" runat="server" Font-Names="Calibri"/></td></tr>
          <tr><td  style="width:12%; font-family: Calibri;"><b>Title:</b></td>
            ...
            <tr><td style="font-family: Calibri;"><b>Department:</b></td>
                ...
                <td style="font-family: Calibri;"><b>&nbsp;</b></td><!--2nd Level Manager Name:-->
                <td><asp:Label ID="lblUP_MGT_NAME" runat="server" Font-Names="Calibri" visible="false"/></td>
                <td style="font-family: Calibri;"><span id="UP_MGT_Apr" runat="server">Approved:</span>&nbsp;&nbsp;</td>
...
<asp:Panel ID="HR_Show" Visible="false" runat="server">
                ...
                <td style="font-family: Calibri;"><span id="HR_Apr" runat="server">Approved:</span>&nbsp;&nbsp;</td>
    ...
    <tr><td>
        <table style="width:100%" border="0">
            <tr><td style="text-align:left" class="auto-style1">&nbsp;
                    <asp:Button ID="Discuss" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" Height="20px" CssClass="Button_StyleSheet" text="Revise" Visible="false"/></td>
...
<asp:Panel ID="Panel_ResetGoals" runat="server" Visible="false">       
    <tr><td style="text-align:left;">
        <asp:Button ID="ResetGoals" runat="server" BackColor="Wheat" ForeColor="red" Font-Bold="true" onclientclick="return confirm('Are you sure you want to delete goal history?');"
        BorderStyle="None" Font-Size="11pt" Height="20px" CssClass="Button_StyleSheet" Text="Reset Goals" />
        </td></tr>
</asp:Panel>  
