<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Manager_Appraisal1.aspx.vb" Inherits="Appraisal.Manager_Appraisal1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Exempt Appraisal</title>
...
<table border="0" style="width:100%" >
 <tr><td class="auto-style1"><img alt="../../images/CR_logo.png" src="../../images/CR_logo.png" /></td></tr>
...
<table style="width:100%">
 ...
 <tr><td style="font-family: Calibri;"><b>Department:</b></td>
     ...
     <td style="font-family: Calibri;">Approved:&nbsp;&nbsp;</td>
     <td><asp:Label ID="LblUP_MGT_Appr" runat="server" Font-Names="Calibri" /></td></tr>
...
<tr><td>
  <table border="0" style="width:100%;">
      <tr><td class="style8">&nbsp;&nbsp;&nbsp;<u>Leadership Competencies:</u>&nbsp;<span class="style7">(Check the box that most appropriately describes your direct report's 
            proficiency level in demonstrating CR's Leadership Competencies)</span></td></tr>
<tr><td>
...
<!--<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>-->
    ...
    <!--<tr><td>&nbsp;</td></tr>-->
    <tr>
        <td class="auto-style1"><u>FY<asp:Label ID="Goal_Year3" runat="server" ForeColor="#00ae4d" CssClass="Label_StyleSheet"/> Goal-Setting Form 
