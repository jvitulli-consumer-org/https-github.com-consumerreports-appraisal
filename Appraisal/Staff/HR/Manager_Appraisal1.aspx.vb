...
Public Class Manager_Appraisal1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        SQL = "select count(*)CNT_Appr_Exist from Appraisal_Master_tbl where emplid=" & lblEMPLID.Text
        'Response.Write(SQL) : Response.End()
        DT = LocalClass.ExecuteSQLDataSet(SQL)
        LocalClass.CloseSQLServerConnection()

        If DT.Rows(0)("CNT_Appr_Exist").ToString = 0 Then
