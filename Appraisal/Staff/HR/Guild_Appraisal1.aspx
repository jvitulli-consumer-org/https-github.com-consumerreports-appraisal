<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Guild_Appraisal1.aspx.vb" Inherits="Appraisal.Guild_Appraisal1" MaintainScrollPositionOnPostback="true"%>
...
<table border="0" style="width:100%" >
 <tr><td class="auto-style1"><img src="../../images/CR_logo.png" /></td></tr>
 <tr><td class="auto-style1"><u>Performance Appraisal (FY<asp:Label ID="FY_Year" runat="server" Text="" ForeColor="#00ae4d" CssClass="Label_StyleSheet"/>)</u></td></tr>
...
<table style="width:100%">
 ...
 <tr><td><b>Title:</b></td>
     ...
     <td style="width:12%; font-family: Calibri;"><b>Manager Name:&nbsp;</b></td>
...
<table border="0">
 <tr><td class="style8">&nbsp;&nbsp;&nbsp;<u>Accomplishments:</u>&nbsp;<span class="style7">(Summarize accomplishments vs the goals/expectations established)</span></td></tr>
  </table>
 </td></tr>     
 <tr><td >
<table border="0" style="border-spacing:0; border-collapse:collapse; width:100%">
  <tr><td style="vertical-align:top; font-family:Calibri;" runat="server">
      <asp:Label ID="txbAccomp1A" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server"/></td></tr>
<tr><td><hr /></td></tr>
</table>
...
<table border="0" style="width:100%">
  ...
  <tr><td style="vertical-align:top; font-family:Calibri;">
      <asp:Label ID="txbStrengthsA" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small"  runat="server"/></td></tr>
    <tr><td><hr /></td></tr>
</table>
  </td></tr>     
...
<table border="0" style="width:100%">
  ...
  <tr><td style="vertical-align:top; font-family:Calibri;">
      <asp:Label ID="txbDevelopment_AreasA" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server"/></td></tr>
  <tr><td><hr /></td></tr>
</table>
  </td>
    </tr>   
...
<table border="0" style="width:100%;">
 ...
 <tr><td style="vertical-align:top; font-family:Calibri;">
     <asp:Label ID="txbOverall_SumA" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server"/></td></tr>
 <tr><td><hr /></td></tr>
</table>
    </td></tr>     
...
<!--Smart Goal-->
<asp:Panel ID="Smart_Goal" runat="server">

<tr><td class="auto-style1"><u>FY<asp:Label ID="Goal_Year3" runat="server" ForeColor="#00ae4d" CssClass="Label_StyleSheet"/> Goal-Setting Form 
...
<tr><td >&nbsp;</td></tr>     
<tr><td style="font-family:Calibri; font-size:medium;" >Enter SMART Goals (<strong>S</strong>pecific, <strong>M</strong>easureable, <strong>A</strong>ttainable, <strong>R</strong>elevant, and <strong>T</strong>ime-bound) to 
    ...
    <div id="divNewtext" runat="server" style="font-size:small; font-style:italic">Please click 
            <a href="https://docs.google.com/presentation/d/1LIm9LOScdiizJcXARapml7-gj2IkJfq-MtQgkBFNHho/edit#slide=id.g1f6e4888fe_0_0" target="_blank">here</a> for a SMART goal example.</div></td></tr>     
<tr><td >
