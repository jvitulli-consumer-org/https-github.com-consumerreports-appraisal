<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="z_AppraisalHR_Reviews.aspx.vb" Inherits="Appraisal.AppraisalHR_Reviews" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
...
<asp:Button ID="lblMessage1" runat="server" ForeColor="Green" BackColor="White" BorderStyle="None" Font-Bold="true" Font-Size="12px" Width="100px" Text="" CssClass="Button_StyleSheet;" style="position:fixed;left:10px; top: 80px;"/><br />
<asp:Button ID="SaveRecords1" runat="server" Text="Save Records" BackColor="Wheat" BorderStyle="None" Width="100px" Font-Size="11pt" CssClass="Button_StyleSheet" style="position:fixed;left:10px; top: 100px;"/>
            </span>
        </td>
        ...
        <td class="style6">
                 <span class="hide_print">
            <asp:ImageButton ID="Img_Print1" runat="server" ImageUrl="../../Images/print.png" Style="width:70px; position:fixed;right:20px; top: 100px;"/>
                     </span>
                     </td></tr>
...
<asp:Panel ID="Panel_Mgt" runat="server">
...
<!--Accomplishments -->
    ...
    <tr><td><asp:Label ID="lblAccomplishment" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false"/></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Accomplishment_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbAccomplishment_Comm" Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommAccomplishment_TextChanged" placeholder="Your Accomplishment Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" 
    Caption="Accomplishment History" CaptionAlign="Left" Font-Size="Smaller">
...
<asp:UpdatePanel ID="UpdatePanel_Comm_Exce" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbComm_Exce1" runat="server" AutoPostBack="true" GroupName="Communic_Impact"/></ContentTemplate></asp:UpdatePanel></td></tr>   
    ...
    <tr><td><asp:TextBox ID="txbLeadership_Comm"  Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommOverall_Sum_TextChanged" placeholder="Your Leadership Competencies Comments" /></ContentTemplate></td></tr>
<tr><td><asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" 
...
<!--Strengths--> 
    ...
    <tr><td><asp:Label ID="lblStrengths" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false"/></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Strengths_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbStrengths_Comm"  Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;"
...
<tr><td><asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" Caption="Strengths History" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
...
<!--Development_Area--> 
    ...
    <tr><td><asp:Label ID="lblDevelopment" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" /></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Development_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbDevelopment_Comm" Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
...
<tr><td><asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" 
...
<asp:TextBox ID="txbOverall_Performance_Comm"  Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommDevelopment_TextChanged" placeholder="Your Performance Rating Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" 
...
<!--5. Overall Summary-->
    ...
    <tr><td><asp:Label ID="lblOverall_Summary" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" /></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Overall_Summary_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbOverall_Summary_Comm"  Width="100%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
...
<tr><td><asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" 
...
<tr><td class="style6">&nbsp;&nbsp;</td>
 ...
 <!--Panel__Waiting_Appraisal-->
 <!--Panel__Waiting_Appraisal END-->
