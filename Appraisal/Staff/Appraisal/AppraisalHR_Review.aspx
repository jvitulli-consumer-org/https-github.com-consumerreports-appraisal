<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AppraisalHR_Review.aspx.vb" Inherits="Appraisal.AppraisalHR_Review" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    function RefreshParent()   {
        //var tkn = document.getElementById('<%'=lblHR_Token.ClientID%>').innerText;
        //alert(window.location.host);
        //window.opener.location.href = "http://" + window.location.host + "/Appraisal/Default_HR.aspx?Token=" + tkn
    }
...
<asp:Label ID="lblHR_Token" runat="server" Visible="true" style="display:none"/>
...
<table border="0">
    ...
    <tr><td class="style6">
          <span class="hide_print">
              <asp:Button ID="lblMessage1" runat="server" ForeColor="Green" BackColor="White" Width="70px" BorderStyle="None" Font-Bold="true" Font-Size="12px" CssClass="Button_StyleSheet" style="position:fixed;right:20px; top:280px;"/><br />
              <asp:Button ID="SaveRecords1" runat="server" Text="Save Records" BackColor="Wheat" Width="100px" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet" style="position:fixed;right:5px; top: 300px;"/></span></td>
...
<!--Panel_Approval_Appraisal-->
<asp:Panel ID="Panel_Guld" runat="server">
...
<table border="0" >
<!--Accomplishments -->
    <tr><td class="style8"><div>&nbsp;&nbsp;&nbsp;<u>Accomplishments:</u>&nbsp;<span class="style7" style="word-wrap: normal; word-break: normal;">(Summarize accomplishments for the rating criteria established)</span></div></td></tr>
    <tr><td><div><asp:Label ID="lblAccomplishment" runat="server" Width="99%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Accomplishment_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
    <tr><td>
<!--<span style="font-weight:bold; color:gray;">Generalist Accomplishment Comments:</span> 
         <asp:RadioButton ID="RdbtYes" runat="server" AutoPostBack="True" Font-Bold="True" GroupName="Accomplishment_Members" OnCheckedChanged="Radiobutton_Yes" Text="Yes"/>
         <asp:RadioButton ID="RdbtNo"  runat="server" AutoPostBack="True" Font-Bold="True" GroupName="Accomplishment_Members" OnCheckedChanged="Radiobutton_No" Text="No"/>-->
<asp:TextBox ID="txbAccomplishment_Comm" Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommAccomplishment_TextChanged" placeholder="Your Accomplishment Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel>
        </td></tr>

<tr><td><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
...
<asp:TemplateField HeaderText="Accomplishment Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="Lbl_Accomp_Comm" runat="server" Text='<%# Eval("Accomp_Comm").ToString().Replace(Environment.NewLine, "<br />")%>' ></asp:Label></div></ItemTemplate></asp:TemplateField> 
...
<table border="1" style="width:100%; border-collapse:collapse; " runat="server">
    <tr><td style="height:30px; text-align:center; font-weight:bold; font-size:large; background-color:#E7E8E3; font-family:Calibri; width:30%">&nbsp;</td>
        <td style="height:30px; text-align:center; font-weight:bold; font-size:large; background-color:#E7E8E3; font-family:Calibri; width:20%; word-wrap: normal; word-break: normal;">Needs Development/Improvement</td>
        <td style="height:30px; text-align:center; font-weight:bold; font-size:large; background-color:#E7E8E3; font-family:Calibri; width:20%; word-wrap: normal; word-break: normal;">Proficient</td>
        <td style="height:30px; text-align:center; font-weight:bold; font-size:large; background-color:#E7E8E3; font-family:Calibri; width:20%; word-wrap: normal; word-break: normal;">Excels</td></tr>
    ...
    <tr id="trMake_Balanced" style="height:33px; font-size:large">
       ...
       <td style="text-align:left; word-wrap: normal; word-break: normal;"><a class="tooltip" href="#"><img src="../../images/info.png" height="15" width="15" border="0"/><span class="custom info">
...
<asp:UpdatePanel ID="UpdatePanel_Comm_Exce" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbComm_Exce1" runat="server" AutoPostBack="true" GroupName="Communic_Impact"/></ContentTemplate></asp:UpdatePanel></td></tr>   
    ...
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Competencies_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
        <asp:TextBox ID="txbCompetencies_Comm"  Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" 
            Rows="4" Style="overflow:auto;" ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommCompetencies_TextChanged" placeholder="Your Competencies Comments" />
</ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
     <asp:TemplateField HeaderText="Competencies Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="LblLead_Comm" runat="server" Text='<%# Eval("Lead_Comm").ToString().Replace(Environment.NewLine, "<br />")%>' ></asp:Label></div></ItemTemplate></asp:TemplateField>    
 </Columns></asp:GridView>
...
<!--Strengths--> 
    ...
    <tr><td><div><asp:Label ID="lblStrengths" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false"/></div></td></tr>
    
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Strengths_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>

<asp:TextBox ID="txbStrengths_Comm"  Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;"
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommStrengths_TextChanged" placeholder="Your Strengths Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
<asp:TemplateField HeaderText="Strengths Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="LblStr_Comm" runat="server" Text='<%# Eval("Str_Comm").ToString().Replace(Environment.NewLine, "<br />")%>' ></asp:Label></div></ItemTemplate></asp:TemplateField> 
</Columns></asp:GridView>
...
<!--Development_Area--> 
    ...
    <tr><td><div><asp:Label ID="lblDevelopment" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" /></div></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Development_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbDevelopment_Comm" Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommDevelopment_TextChanged" placeholder="Your Development Areas Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>

<asp:TemplateField HeaderText="Development Area Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="LblDev_Comm" runat="server" Text='<%# Eval("Dev_Comm").ToString().Replace(Environment.NewLine, "<br />")%>'></asp:Label></div></ItemTemplate></asp:TemplateField> 
...
<!--Overall Performance Rating-->
    <tr><td class="style8"><div>&nbsp;&nbsp;&nbsp;<u>Overall Performance Rating:</u><span class="style7" stye="word-wrap: normal; word-break: normal;"> (Check the box that most appropriately describes the individual&#39;s overall performance)</span></div></td></tr>
    <tr><td>
<table border="1" style="width:100%; border-spacing:0; border-color:black; border-collapse:collapse; border-spacing:0;" runat="server">
   <tr><td class="style9" style="word-wrap: normal; word-break: normal;"><a class="tooltip" href="#"><img src="../../images/info.png" height="15" width="15" border="0"/><span class="custom info">
       ...
       <td class="style9" style="word-wrap: normal; word-break: normal;"><a class="tooltip" href="#"><img src="../../images/info.png" height="15" width="15" border="0"/><span class="custom info">
          <u><b>Developing/Improving Contributor</b></u><br /><br />This employee is still learning the essential functions of the position, or is improving toward effective performance of all essential functions. Continued development or improvement 
           ...
           Employees should not receive this rating in consecutive years. Employees continuing to require significant development a year after receiving this rating should  be rated as “unsatisfactory”.</span></a>&nbsp;&nbsp;<b>Developing/Improving 
           Contributor</b>&nbsp;&nbsp;</td>        
       <td class="style9" style="word-wrap: normal; word-break: normal;"><a class="tooltip" href="#"><img src="../../images/info.png" height="15" width="15" border="0"/><span class="custom info">
   ...
   <tr id="trOverall_Performance"><td id="tdBelow" style="text-align:center;">
...
<asp:UpdatePanel ID="UpdatePanel_Rating_Disting" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbDisting" runat="server" text="" GroupName="OverAll" AutoPostBack="True"/></ContentTemplate></asp:UpdatePanel></td></tr></table>
    ...
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Overall_Performance_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbOverall_Performance_Comm"  Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommOverall_Performance_TextChanged" placeholder="Your Performance Rating Comments"></asp:TextBox></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
<asp:TemplateField HeaderText="Overall Performance Rating Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="LblRate_Comm" runat="server" Text='<%# Eval("Rate_Comm").ToString().Replace(Environment.NewLine, "<br />")%>' ></asp:Label></div></ItemTemplate></asp:TemplateField> 
</Columns></asp:GridView>
...
<!--5. Overall Summary-->
    ...
    <tr><td><div><asp:Label ID="lblOverall_Summary" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" /></div></td></tr>
    <tr><td>
<asp:UpdatePanel ID="UpdatePanel_Overall_Summary_Comm" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbOverall_Summary_Comm"  Width="99%" Borderstyle="Solid" BorderColor="green" BorderWidth="2px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" 
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="CommOverall_Sum_TextChanged" placeholder="Your Overall Summary Comments" /></ContentTemplate></asp:UpdatePanel></td></tr>
<tr><td><asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
...
<asp:TemplateField HeaderText="Overall Summary Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
<div><asp:Label ID="LblSum_Comm" runat="server" Text='<%# Eval("Sum_Comm").ToString().Replace(Environment.NewLine, "<br />")%>' ></asp:Label></div></ItemTemplate></asp:TemplateField>    
...
<asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:GlobalSQLDataConnection %>"></asp:SqlDataSource></td></tr>    
    ...
    <tr><td>
       <table width="100%" ><tr>
             <td style="width:50%; text-align:left; "><asp:Button ID="btnDiscuss" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet"  Height="24px"/></td>
             <td style="width:50%; text-align:right;"><asp:Button ID="btnApproved" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet" Height="24px"/></td></tr></table>
        </td></tr>
    <tr><td>&nbsp;&nbsp;</td></tr>
...
<tr><td class="style6">&nbsp;&nbsp;</td>
    <td class="style1"><span class="hide_print"><asp:ImageButton ID="Img_Print1" runat="server" ImageUrl="../../Images/print.png" Style="width:70px;"/></span></td>
    <td class="style6">&nbsp;&nbsp;</td></tr>
...
<tr><td class="style6">&nbsp;&nbsp;</td>
    <td style="text-align:center"><span class="hide_print"><asp:Button ID="Button1" Text="Close" runat="server" style="border-style:none; color:Blue; width:120px; font-weight:bold; cursor: pointer;" 
            CssClass="Button_StyleSheet" OnClientClick="javascript:window.open('','_self',''); window.close(); return false;" /></span></td>
    <td class="style6">&nbsp;&nbsp;</td></tr>       
