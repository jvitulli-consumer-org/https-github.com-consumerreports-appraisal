...
Public Class Appraisal_Edit
    Inherits System.Web.UI.Page
    Dim SQL, SQL1, SQL2, SQL3, SQL4, SQL5, SQL6, SQL7, SQL8, SQL9, SQL10, SQL11, SQL12, SQL13, SQL14, z, x, ReturnValue As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'x = Request.QueryString("Nov")
        'If Request.QueryString("Nov") > 0 Then
        'Response.Redirect("Appraisal/Logon.aspx?Dev=" & x)
        'End If
    ...
    Protected Sub SetLevel_Approval()
        ...
        If DT.Rows(0)("Process_flag").ToString = 0 Then '--Manager create/edit
            ...
            If CDbl(lblFIRST_MGT_EMPLID.Text) - CDbl(lblHR_EMPLID.Text) = 0 Then '--If generalist same as manager
                btnSubmit_Generalist.Visible = False : btnSendEmployee.Visible = True : btnSendEmployee.Text = "Send Appraisal to " & lblEmpl_NAME.Text
            Else
    ...
    Protected Sub DisplayData()
        ...
        If DT.Rows(0)("Process_flag").ToString = 0 Then '--Manager create Appraisal 
            ...
            lblOverall_Summary_Comm.Text = Replace(Replace(DT.Rows(0)("Summary_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
        ...
        ElseIf DT.Rows(0)("Process_flag").ToString = 1 Then
            ...
            If Len(DT.Rows(0)("Accomplishment_Comm").ToString) > 4 Then
                ...
                lblAccomplishment_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                    Replace(Replace(DT.Rows(0)("Accomplishment_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
            ...
            If Len(DT.Rows(0)("Strengths_Comm").ToString) > 4 Then
                ...
                lblStrengths_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                    Replace(Replace(DT.Rows(0)("Strengths_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
            ...
            If Len(DT.Rows(0)("Development_Comm").ToString) > 4 Then
                lblDevelopment_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                Replace(Replace(DT.Rows(0)("Development_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
            ...
            If Len(DT.Rows(0)("Rating_Comm").ToString) > 4 Then
                lblOverall_Performance_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                 Replace(Replace(DT.Rows(0)("Rating_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
            '5. Overall Summary---
            ...
            If Len(DT.Rows(0)("Summary_Comm").ToString) > 4 Then
                lblOverall_Summary_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                Replace(Replace(DT.Rows(0)("Summary_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
            ...
            If Len(DT.Rows(0)("Leadership_Comm").ToString) > 4 Then
                lblLeaderShip_Comm.Text = "<b>On " & DT.Rows(0)("Datetime").ToString & " " & DT.Rows(0)("Rej_Generalist").ToString & " has comments:</b><br> " & _
                Replace(Replace(DT.Rows(0)("Leadership_Comm").ToString, Chr(13), "<span>"), Chr(10), "<br>")
            End If
    ...
    Protected Sub Discussion_Comments()
        ...
        SqlDataSource1.SelectCommand &= " (select IsNull(Max(DateTime),'01/01/'+convert(char(4),Year(Getdate()))) from Appraisal_Discussion_tbl A where Perf_Year=" & lblYEAR.Text & " and emplid=" & lblEMPLID.Text & " and Comments='Edit') "
        ...
        SqlDataSource3.SelectCommand &= " and emplid=" & lblEMPLID.Text & ") and len(Strengths_Comm)>4 and Version>0 and DateTime>"
        SqlDataSource3.SelectCommand &= " (select IsNull(Max(DateTime),'01/01/'+convert(char(4),Year(Getdate()))) from Appraisal_Discussion_tbl A where Perf_Year=" & lblYEAR.Text & " and emplid=" & lblEMPLID.Text & " and Comments='Edit') "
        ...
        SqlDataSource4.SelectCommand &= " (select IsNull(Max(DateTime),'01/01/'+convert(char(4),Year(Getdate()))) from Appraisal_Discussion_tbl A where Perf_Year=" & lblYEAR.Text & " and emplid=" & lblEMPLID.Text & " and Comments='Edit') "
        ...
        SqlDataSource5.SelectCommand &= " (select IsNull(Max(DateTime),'01/01/'+convert(char(4),Year(Getdate()))) from Appraisal_Discussion_tbl A where Perf_Year=" & lblYEAR.Text & " and emplid=" & lblEMPLID.Text & " and Comments='Edit') "
        ...
        SqlDataSource6.SelectCommand &= " (select IsNull(Max(DateTime),'01/01/'+convert(char(4),Year(Getdate()))) from Appraisal_Discussion_tbl A where Perf_Year=" & lblYEAR.Text & " and emplid=" & lblEMPLID.Text & " and Comments='Edit') "
    ...
    Protected Sub SaveData()
        ...
        SQL1 = "Update Appraisal_Master_TBL Set "
        SQL1 &= "Strengths='" & Replace(Replace(Replace(Replace(txbStrengths.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "',"
        SQL1 &= "Development_Area='" & Replace(Replace(Replace(Replace(txbDevelopment.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "',"
        SQL1 &= "Overall_Summary= '" & Replace(Replace(Replace(Replace(txbOverall_Summary.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "'"
        '---Oveall Performance Rating
        ...
        SQL1 &= " Update Appraisal_Accomplishments_TBL Set Accomplishment= '" & Replace(Replace(Replace(Replace(txbAccomplishment.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "' "
    ...
    Protected Sub AllRules()
        ...
        If CDbl(DT.Rows(0)("Acom1").ToString) = 1 Then
            ...
            DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
            If CDbl(DT1.Rows(0)("Accomplishment1").ToString) < 2 Then txbAccomplishment.BackColor = Drawing.Color.Yellow : Flag = 1 Else txbAccomplishment.BackColor = Drawing.Color.White
        End If
        '---2. Check Strengths in Master table ---
        If CDbl(DT.Rows(0)("Len_Str").ToString) < 2 Then txbStrengths.BackColor = Drawing.Color.Yellow : Flag = 1 Else txbStrengths.BackColor = Drawing.Color.White
        '---3. Check Development Areas in Master table ---
        If CDbl(DT.Rows(0)("Len_DevArea").ToString) < 2 Then txbDevelopment.BackColor = Drawing.Color.Yellow : Flag = 1 Else txbDevelopment.BackColor = Drawing.Color.White
        '---4. Check Overall Summary in Master table ---
        If CDbl(DT.Rows(0)("Len_OverSum").ToString) < 2 Then txbOverall_Summary.BackColor = Drawing.Color.Yellow : Flag = 1 Else txbOverall_Summary.BackColor = Drawing.Color.White
    ...
    Protected Sub ResetYellowColor()
        ...
        '---1. ACCOMPLISHMENT TABLE---
        If CDbl(DT14.Rows(0)("Acom1").ToString) = 1 Then txbAccomplishment.BackColor = Drawing.Color.White

        '---2. Check Strengths, Development Areas,Overall Summary,Overall Performance   in Master table ---
        txbStrengths.BackColor = Drawing.Color.White : txbDevelopment.BackColor = Drawing.Color.White
        txbOverall_Summary.BackColor = Drawing.Color.White : trOverall_Performance.BgColor = "White"

        '---3. Leadership Competencies in Master table ---
    ...
    Protected Sub SendToGeneralist()
        ...
        'Response.Write(CDbl(lblFIRST_MGT_EMPLID.Text) - CDbl(lblHR_EMPLID.Text)) : Response.End()

        If (CDbl(lblFIRST_MGT_EMPLID.Text) - CDbl(lblHR_EMPLID.Text) = 0) Or (lblFIRST_MGT_EMPLID.Text = 6193 And lblHR_EMPLID.Text = 6785) Then

            SQL = "Update Appraisal_MASTER_tbl set DateSUB_Empl='" & Now & "',DateHR_Appr='" & Now & "',Process_Flag=4 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text
            'Response.Write(SQL) : Response.End()
            DT = LocalClass.ExecuteSQLDataSet(SQL)
            LocalClass.CloseSQLServerConnection()
            ...
            '("vituja@consumer.org", "Your Performance Appraisal is ready for your review", Msg)

            Response.Redirect("Appraisal_Edit.aspx?Token=" & z)
            LocalClass.CloseSQLServerConnection()
        ...
        Else
            ...
            '("zubama@consumer.org", "Performance Appraisal was sent to you for Approval by " & Session("NAME"), Msg)
    ...
    Protected Sub Accomplishments_TextChanged(sender As Object, e As EventArgs) Handles txbAccomplishment.TextChanged
        SQL &= " Update Appraisal_Accomplishments_TBL Set Accomplishment= '" & Replace(Replace(Replace(Replace(txbAccomplishment.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "' "
        SQL &= " where IndexId=1 and Perf_Year = " & lblYEAR.Text & " and EMPLID = " & lblEMPLID.Text & " "
        DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
        LocalClass.CloseSQLServerConnection()
        ResetYellowColor()
    ...
    Protected Sub Strengths_TextChanged(sender As Object, e As EventArgs) Handles txbStrengths.TextChanged
        SQL &= " Update Appraisal_Master_TBL Set Strengths= '" & Replace(Replace(Replace(Replace(txbStrengths.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "' "
        SQL &= " where IndexId=1 and Perf_Year = " & lblYEAR.Text & " and EMPLID = " & lblEMPLID.Text & " "
        DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
        LocalClass.CloseSQLServerConnection()
        ResetYellowColor()
    ...
    Protected Sub Development_TextChanged(sender As Object, e As EventArgs) Handles txbDevelopment.TextChanged
        SQL &= " Update Appraisal_Master_TBL Set Development_Area= '" & Replace(Replace(Replace(Replace(txbDevelopment.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "' "
        SQL &= " where IndexId=1 and Perf_Year = " & lblYEAR.Text & " and EMPLID = " & lblEMPLID.Text & " "
        DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
        LocalClass.CloseSQLServerConnection()
        ResetYellowColor()
    ...
    Protected Sub Overall_Sum_TextChanged(sender As Object, e As EventArgs) Handles txbOverall_Summary.TextChanged
        SQL &= " Update Appraisal_Master_TBL Set Overall_Summary= '" & Replace(Replace(Replace(Replace(txbOverall_Summary.Text, "'", "`"), "<", "{"), ">", "}"), "<br>", Chr(13)) & "' "
        SQL &= " where IndexId=1 and Perf_Year = " & lblYEAR.Text & " and EMPLID = " & lblEMPLID.Text & " "
        DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
        LocalClass.CloseSQLServerConnection()
        ResetYellowColor()
    ...
    Protected Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        If Len(lblLogin_EMPLID.Text) > 0 Then
            ...
            If (lblLogin_EMPLID.Text <> lblEMPLID.Text) And (CDbl(lblProcess_Flag.Text) = 0 Or CDbl(lblProcess_Flag.Text) = 1) Then
                SQL11 = "select Window_batch from Appraisal_Master_TBL where emplid=" & lblEMPLID.Text & " and Perf_Year= " & lblYEAR.Text
                DT11 = LocalClass.ExecuteSQLDataSet(SQL11)

                If lblWindowBatch.Text <> CDbl(DT11.Rows(0)("Window_batch").ToString) And (CDbl(lblProcess_Flag.Text) = 0 Or CDbl(lblProcess_Flag.Text) = 1) Then
    ...
    Protected Sub RefuseSign_Click(sender As Object, e As EventArgs) Handles RefuseSign.Click
        ...
        Else
            ...
            SQL1 = "select count(*)CNT_Esign from Appraisal_Master_Esign_tbl where emplid=" & lblEMPLID.Text & "  and Perf_Year=" & lblYEAR.Text
            'Response.Write(SQL1) ': Response.End()
            DT1 = LocalClass.ExecuteSQLDataSet(SQL1)

            If DT1.Rows(0)("CNT_Esign").ToString = 0 Then
                SQL2 = "Insert into Appraisal_Master_Esign_tbl values(" & lblEMPLID.Text & "," & lblYEAR.Text & "," & lblFIRST_MGT_EMPLID.Text & ",'" & Now & "')"
            Else
                SQL2 = "Update Appraisal_Master_Esign_tbl Set Date_Esign ='" & Now & "' where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text
            End If
