<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Appraisal_Edit.aspx.vb" Inherits="Appraisal.Appraisal_Edit" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
...
<tr><td><div><asp:Label ID="lblAccomplishment" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></td></tr>
<tr><td>    

<asp:UpdatePanel ID="UpdatePanel_Accomplishment" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbAccomplishment" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Style="overflow:auto; word-wrap:normal; word-break:normal;"  
    TextMode="MultiLine" Rows="5" TabIndex="1" Wrap="true" ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Accomplishments_TextChanged" onkeyup="ChangeColor(id);" />
</ContentTemplate></asp:UpdatePanel></td></tr>

<tr><td><span class="hide_print"><asp:Label ID="lblAccomplishment_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></span></td></tr>

<tr><td><span class="hide_print"> 
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
...
<asp:UpdatePanel ID="UpdatePanel_Comm_Exce" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbComm_Exce1" runat="server" AutoPostBack="true" GroupName="Communic_Impact"/></ContentTemplate></asp:UpdatePanel></td></tr>   
    ...
    <tr><td><span class="hide_print"><div><asp:Label ID="lblLeaderShip_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></span></td></tr>
<tr><td><span class="hide_print">
<asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
...
<!--Strengths--> 
    <tr><td class="style8"><div>&nbsp;&nbsp;&nbsp;<u>Strengths:</u>&nbsp;<span class="style7">(Comment on key strengths and highlight areas performed well)</span></div></td></tr>
        <tr><td><div><asp:Label ID="lblStrengths" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div>

<asp:UpdatePanel ID="UpdatePanel_Strengths" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbStrengths"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="5" Style="overflow:auto; word-wrap:normal; word-break:normal;" 
    TabIndex="2" ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Strengths_TextChanged" onkeyup="ChangeColor(id);" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><span class="hide_print"><div><asp:Label ID="lblStrengths_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></span></td></tr>
<tr><td><span class="hide_print">
<asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
...
<!--Development_Area--> 
    ...
    <tr><td><div><asp:Label ID="lblDevelopment" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div>
<asp:UpdatePanel ID="UpdatePanel_Development" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbDevelopment"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="5" Style="overflow:auto; word-wrap:normal; word-break:normal;" 
    TabIndex="3" ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Development_TextChanged" onkeyup="ChangeColor(id);" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><span class="hide_print"><div><asp:Label ID="lblDevelopment_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></span></td></tr>
<tr><td><span class="hide_print">
<asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
<asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
<asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
...
<!--Overall Performance Rating-->
    <tr><td class="style8"><div>&nbsp;&nbsp;&nbsp;<u>Overall Performance Rating:</u><span class="style7" style="word-wrap: normal; word-break: normal;"> (Check the box that most appropriately describes the individual&#39;s overall performance)</span></div></td></tr>
    <tr><td>
...
<asp:UpdatePanel ID="UpdatePanel_Rating_Disting" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbDisting" runat="server" text="" GroupName="OverAll" AutoPostBack="True"/></ContentTemplate></asp:UpdatePanel></td></tr></table>
    ...
    <tr><td><span class="hide_print"><div><asp:Label ID="lblOverall_Performance_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></span></td></tr>
<tr><td><span class="hide_print">
<asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
  <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
  <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
...
<!--5. Overall Summary-->
    ...
    <tr><td><div><asp:Label ID="lblOverall_Summary" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div>
<asp:UpdatePanel ID="UpdatePanel_Overall_Summary" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbOverall_Summary"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="5" Style="overflow:auto; word-wrap:normal; word-break:normal;" 
    TabIndex="4" ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Overall_Sum_TextChanged" onkeyup="ChangeColor(id);" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><span class="hide_print"><div><asp:Label ID="lblOverall_Summary_Comm" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" Visible="false"/></div></span></td></tr>
<tr><td><span class="hide_print">

<asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 <AlternatingRowStyle BackColor="#ccffff" />
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
...
<asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:GlobalSQLDataConnection %>"></asp:SqlDataSource>
    ...
    <tr><td>&nbsp;&nbsp;</td></tr>
    <tr><td><span class="hide_print"><asp:Button ID="btnSubmit_Generalist" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet" Visible="false"/></span></td></tr>
    
    <tr><td>
<span class="hide_print">
<table width="100%">
   <tr><td style="text-align:left; width:20%;"><span class="hide_print"><asp:Button ID="btnEditForm" runat="server" BackColor="Wheat" BorderStyle="None" CssClass="Button_StyleSheet" Font-Size="11pt" Visible="false" 
           OnClientClick="return confirm(&quot;Clicking OK will allow you to make edits to the existing text and send it back to HR.&quot;);" /></span></td>
        <td>
<!--Emploee Declined-->
<table style="width:100%;" border="0">
   <tr><td style="text-align:center;"><asp:Label ID="lblRefuseText" runat="server" ForeColor="blue" Font-Size="Smaller" Width="60%" Style="word-wrap: normal; word-break: normal;"/></td></tr> 
...
<asp:Button ID="RefuseSign" runat="server" Text="Employee Declined to Sign" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" width="200px" Visible="false" CssClass="TextBox_StyleSheet"
...
<!--END Employee Declined-->
      ...
      <td style="text-align:right; width:20%;"><span class="hide_print"><asp:Button ID="btnSendEmployee" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" Visible="false" CssClass="Button_StyleSheet"/></span></td></tr></table>
</span>
        </td></tr>
    <tr><td></td></tr>
    <tr><td>
...
<tr><td class="style6">&nbsp;&nbsp;</td>
       <td style="text-align:center"><span class="hide_print"><asp:Button ID="Button2" Text="Close" runat="server" style="border-style:none; color:Blue; width:120px; font-weight:bold; cursor: pointer;" 
