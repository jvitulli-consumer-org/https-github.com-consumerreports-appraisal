<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AppraisalForm.aspx.vb" Inherits="Appraisal.AppraisalForm" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
...
<table border="0" class="style0">
    ...
    <tr><td class="style6">
      <span class="hide_print">
        <asp:Button ID="lblMessage1" runat="server" ForeColor="Green" BackColor="White" BorderStyle="None" Font-Bold="true" Font-Size="12px" Width="120px" Text="" CssClass="Button_StyleSheet" style="position:fixed;left:50px;"/><br />
        <asp:Button ID="SaveRecords1" runat="server" Text="Save Records" BackColor="Wheat" BorderStyle="None" Width="120px" Font-Size="11pt" CssClass="Button_StyleSheet" style="position:fixed;left:50px;"/></span></td>
        ...
        <td class="style1">
             <span class="hide_print">
            <asp:ImageButton ID="Img_Print1" runat="server" ImageUrl="../../Images/print.png" Style="width:70px; position:fixed;right:80px; top:130px;" onclientclick="javascript:window.print();" />
              </span></td></tr>
...
<!--Accomplishments -->
    ...
    <tr><td><asp:Label ID="lblAccomplishment" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" />
<asp:UpdatePanel ID="UpdatePanel_Accomplishment" runat="server" UpdateMode="Conditional"><ContentTemplate>
<asp:TextBox ID="txbAccomplishment" runat="server" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" TextMode="MultiLine" Rows="4" Style="overflow:auto;" TabIndex="1"
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Accomplishments_TextChanged"  onkeyup="textAreaAdjust(this)" onfocus="textAreaAdjust(this)" onmouseout="textAreaAdjust(this)" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><asp:Label ID="lblAccomplishment_Comm" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" /></td></tr>
    <tr><td><hr /></td></tr>
...
<asp:TextBox ID="txbStrengths"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" TabIndex="2"
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Strengths_TextChanged"  onkeyup="textAreaAdjust(this)" onfocus="textAreaAdjust(this)" onmouseout="textAreaAdjust(this)" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><asp:Label ID="lblStrengths_Comm" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" /></td></tr>
    <tr><td><hr /></td></tr>
...
<asp:TextBox ID="txbDevelopment"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" TabIndex="3"
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Development_TextChanged"  onkeyup="textAreaAdjust(this)" onfocus="textAreaAdjust(this)" onmouseout="textAreaAdjust(this)" /></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><asp:Label ID="lblDevelopment_Comm" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" Visible="false" /></td></tr>
    <tr><td><hr /></td></tr>
...
<asp:UpdatePanel ID="UpdatePanel_Rating_Disting" runat="server" UpdateMode="Conditional"><ContentTemplate><asp:RadioButton ID="rbDisting" runat="server" text="" GroupName="OverAll" AutoPostBack="True"/></ContentTemplate></asp:UpdatePanel></td></tr></table>
    ...
    <tr><td><asp:Label ID="lblOverall_Performance_Comm" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" /></td></tr>
    <tr><td><hr /></td></tr>
...
<asp:TextBox ID="txbOverall_Summary"  Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" TextMode="MultiLine" Rows="4" Style="overflow:auto;" TabIndex="4"
     ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Overall_Sum_TextChanged" onkeyup="textAreaAdjust(this)" onfocus="textAreaAdjust(this)" onmouseout="textAreaAdjust(this)"/></ContentTemplate></asp:UpdatePanel></td></tr>
    <tr><td><asp:Label ID="lblOverall_Summary_Comm" Width="100%" Borderstyle="Solid" BorderColor="LightGray" BorderWidth="1px" Font-Names="Calibri" Font-Size="Small" runat="server" /></td></tr>
    <tr><td><hr /></td></tr>
...
<!--Addendum -->     
    ...
    <tr><td class="style7">Check the box that most appropriately describes your direct report's proficiency level in demonstrating CR's Leadership Competencies. 
        Use this as a guide to provide feedback and guide your direct report on areas to focus on for further growth and development.</td></tr>
    <tr><td>
