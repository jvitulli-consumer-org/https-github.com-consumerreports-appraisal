<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="z_Appraisal_Edit_Guild.aspx.vb" Inherits="Appraisal.Appraisal_Edit_Guild" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
...
<table border="0" class="style0">
    ...
    <tr><td class="style6">
      <span class="hide_print">
        <asp:Button ID="lblMessage1" runat="server" ForeColor="Green" BackColor="White" BorderStyle="None" Font-Bold="true" Font-Size="12px" CssClass="Button_StyleSheet" style="position:fixed;left:10px; top:380px;"/><br />
        <asp:Button ID="SaveRecords1" runat="server" Text="Save Records" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet" style="position:fixed;left:8px; top: 400px;"/></span></td>
        ...
        <td class="style1">
             <span class="hide_print">
            <asp:ImageButton ID="Img_Print1" runat="server" ImageUrl="../../Images/print.png" Style="width:70px; position:fixed;right:20px; top:400px;" onclientclick="javascript:window.print();" />
              </span></td></tr>
...
<tr><td><hr /></td></tr>
<!--Addendum -->     
<tr><td class="style8">&nbsp;&nbsp;&nbsp;<u>Competencies</u>&nbsp;<span class="style7">(Check the box that most appropriately describes your direct report's proficiency level in demonstrating CR's Leadership Competencies. 
...
<asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" Width="100%" DataKeyNames="EMPLID" HeaderStyle-ForeColor="Blue" CaptionAlign="Left" Font-Size="Smaller">
 ...
 <Columns>
   <asp:BoundField DataField="DateTime" HeaderText="Date Time" HeaderStyle-BackColor="LightGray"  HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-VerticalAlign="Top" ></asp:BoundField>
   <asp:BoundField DataField="Generalist" HeaderText="Generalist" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="15%" ItemStyle-VerticalAlign="Top"></asp:BoundField>
<asp:TemplateField HeaderText="Leadership Competencies Comments History" HeaderStyle-BackColor="LightGray" HeaderStyle-HorizontalAlign="Left"><ItemTemplate>
