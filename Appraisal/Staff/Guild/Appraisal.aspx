<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Appraisal.aspx.vb" Inherits="Appraisal.Appraisal" MaintainScrollPositionOnPostback="true" smartNavigation="true" ValidateRequest="false"%>
...
//========================================================================
    ...
    //var checkSessionTimeout = function () {
        ...
        //if (minutes > 20) {
            //setInterval(function () { location.href = 'Guild\Staff\Default.aspx' }, 5000)
        //}
    //};
...
<asp:UpdatePanel ID="UpdatePanel_Accomp1" runat="server" UpdateMode="Conditional"><ContentTemplate>
          <asp:TextBox ID="txbAccomp1" runat="server" Width="99%" Font-Names="Calibri" Borderstyle="Solid" BorderColor="LightGray" TextMode="MultiLine" Rows="5" Style="overflow:auto;" TabIndex="1"
               ValidateRequestMode="Disabled" AutoPostBack="true" OnTextChanged="Accomplishments1_TextChanged" onkeyup="ChangeColor(id);" />
...
<table border="0" style="width:99%">
  <tr><td colspan="5" class="style8">&nbsp;&nbsp;&nbsp;<u>Overall Performance Rating:</u>
      <span class="style7"> (Check the box that most appropriately describes the individual&#39;s overall performance)  </span></td></tr>
  <tr><td>
...
<asp:UpdatePanel ID="UpdatePanel_DiscussionComments" runat="server" UpdateMode="Conditional"> <ContentTemplate>    
   <asp:TextBox ID="DiscussionComments" runat="server" Width="99%" Font-Names="Calibri" Borderstyle="Solid" BorderColor="LightGray" TextMode="MultiLine" ValidateRequestMode="Disabled" 
    ...
    <tr><td style="width:35%; text-align:left;">
              ...
              <asp:Button ID="btnDiscuss" runat="server" BackColor="Wheat" BorderStyle="None" Font-Size="11pt" CssClass="Button_StyleSheet" Height="24px"/></td>
...
<div id="divCalendar" style="position:absolute; height: 207px;">
