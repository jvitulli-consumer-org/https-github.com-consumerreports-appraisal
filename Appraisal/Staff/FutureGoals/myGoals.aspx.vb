...
Public Class myGoals
    ...
    Protected Sub GoalStatus()

        '--Edit - flag= 0,1; Send - flag= 2; Approved - flag= 5;
        ...
        If CDbl(DT9.Rows(0)("Process_Flag").ToString) = 0 Or CDbl(DT9.Rows(0)("Process_Flag").ToString) = 1 Then '--Start / Edit
        ...
        ElseIf CDbl(DT9.Rows(0)("Process_Flag").ToString) = 3 Then
            Goal_Setting_Edit.Visible = True
            Goal_Setting_Review.Visible = False
            btnSend.Visible = True
            btnSave2.Visible = True
        ...
        ElseIf CDbl(DT9.Rows(0)("Process_Flag").ToString) = 5 Then
            Goal_Setting_Edit.Visible = False
            Goal_Setting_Review.Visible = True
    ...
    Protected Sub ShowButtonCursor()
        ...
        btnEdit.Attributes.Add("onMouseOver", "this.style.color='blue';this.style.cursor='pointer';") : btnEdit.Attributes.Add("onmouseout", "this.style.color='#000000'")
        btnSend.Attributes.Add("onMouseOver", "this.style.color='blue';this.style.cursor='pointer';") : btnSend.Attributes.Add("onmouseout", "this.style.color='#000000'")
    ...
    Protected Sub btnNew_Goal_Click(sender As Object, e As EventArgs) Handles btnNew_Goal.Click
        ...
        If CDbl(DT.Rows(0)("CNT_FUT").ToString) = 0 Then
            SQL3 = " insert into Appraisal_FutureGoals_tbl (EMPLID,Perf_Year,IndexID,Appr_Goals,Goals,Milestones,TargetDate,DateEmpl_Appr,MGT_EMPLID) values(" & lblEMPLID.Text & "," & lblYear.Text & ",1,0,'','','',NULL,'')"
        ...
        Else
            ...
            SQL4 &= " (" & lblEMPLID.Text & ", " & lblYear.Text & " ," & DT2.Rows(0)("NewIndexID").ToString & ",0,'','','',NULL,'')"
    ...
    Protected Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        SQL = "Update Appraisal_FutureGoals_Master_tbl Set Process_Flag=1 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYear.Text & " "
        DT = LocalClass.ExecuteSQLDataSet(SQL)
        GoalStatus()
    ...
    Protected Sub SendToManager()
        SQL = "Update Appraisal_FutureGoals_Master_tbl Set Process_Flag=2 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYear.Text & "  "
        SQL &= " Update Appraisal_FutureGoals_tbl Set Appr_Goals=1 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYear.Text & " "
        DT = LocalClass.ExecuteSQLDataSet(SQL)

        Msg = lblEmpl_NAME.Text & " created Goals and has sent them to you for review.<br><br>"
        Msg &= "Please click on the link http://" & Request.Url.Host & "/Appraisal/default.aspx for full details to revise or approve."

        '--Production Email
        LocalClass.SendMail(lblFirst_SUP_EMAIL.Text, "Employee Created Goals", Msg)

        '("zubama@consumer.org", "Employee Created Goals", Msg)
        ...
        Response.Redirect("myGoals.aspx?Token=" & Request.QueryString("Token"))
    End Sub
