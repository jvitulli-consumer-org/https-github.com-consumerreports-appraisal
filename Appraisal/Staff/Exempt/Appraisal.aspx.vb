...
Public Class Exempt_Appraisal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'HR_Generalist()
        'Response.Write(CDbl(Len(z)) & "<br>" & CDbl(Session("CNT_HR")))
        'If CDbl(Len(z)) <= 8 And CDbl(Session("CNT_HR")) = 0 Then '--Len(EMPLID) < 4 
        'Response.Write(z & "<br>1. length of the URL " & Len(z)) : Response.End()
        'lblEMPLID.Text = Mid(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Request.QueryString("Token"), "a", "0"), "z", "1"), "x", "2"), "d", "3"), "v", "4"), "g", "5"), "n", "6"), "k", "7"), "i", "8"), "q", "9"), 5, 2)
        'lblYEAR.Text = Left(Request.QueryString("Token"), 4)
        'lblWindowBatch.Text = Mid(Request.QueryString("Token"), 7)
        'lblDataBaseBatch.Text = Session("Window_batch")
        'Response.Write("lblEMPLID " & lblEMPLID.Text & "<br>lblYEAR " & lblYEAR.Text & "<br>lblWindowBatch " & lblWindowBatch.Text & "<br>lblDataBatch " & lblDataBaseBatch.Text) : Response.End()
        'Else
        'Response.Write(z & "<br>2. length of the URL " & Len(z)) : Response.End()
    ...
    End Sub
    Protected Sub HR_Generalist()
        SQL = "select count(*)CNT_HR from hr_pds_data_tbl where emplid =" & Session("MGT_EMPLID") & " and deptid=9009120"
        DT = LocalClass.ExecuteSQLDataSet(SQL)
        Session("CNT_HR") = CDbl(DT.Rows(0)("CNT_HR").ToString)
    ...
    Protected Sub SetLevel_Approval()
        ...
        'Response.Write(lblSECOND_MGT_EMPLID.Text & "<br>" & lblUP_MGT_Email.Text)
        ...
        If lblMGT_EMPLID.Text = 99999 Then
            Session("FIRST_MGT") = 2
        ElseIf CDbl(lblEMPLID.Text) - CDbl(lblMGT_EMPLID.Text) = 0 Then
            Session("FIRST_MGT") = 2
        Else
        ...
        If CDbl(DT.Rows(0)("Process_Flag").ToString) = 0 Then
            ...
            If CDbl(Trim(lblFIRST_MGT_EMPLID.Text)) - CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) = 0 Then
                ...
                If CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) - CDbl(Trim(lblHR_EMPLID.Text)) = 0 Then
                    btnSubmit_UpperMgr.Text = "Send Appraisal to " & lblEmpl_NAME.Text  '--Send to Employee -  bypass fist/second managers and generalist if they are the same
                ...
                End If
            Else
                'btnSubmit_UpperMgr.Text = "Submit for Review to " & DT.Rows(0)("UP_MGT_Name").ToString '--no bypass Process_Flag=1

                If lblMGT_EMPLID.Text = 6785 Then
                    btnSubmit_UpperMgr.Text = "Send Appraisal to " & lblEmpl_NAME.Text '--Send to Employee -  bypass fist/second managers and generalist if they are the same
                Else
        ...
        ElseIf CDbl(DT.Rows(0)("Process_Flag").ToString) = 1 And Session("FIRST_MGT") = 0 Then
            ...
            If CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) - CDbl(Trim(lblHR_EMPLID.Text)) = 0 Then
                ...
                LblMGT_Appr.Text = DT.Rows(0)("DateSUB_UP_MGT").ToString
                LblUP_MGT_Appr.Text = "Waiting Approval" 'DT.Rows(0)("DateSUB_HR").ToString
    ...
    Protected Sub SaveRecords1_Click(sender As Object, e As EventArgs) Handles SaveRecords1.Click
        ...
        If CDbl(Session("Window_batch")) = CDbl(lblWindowBatch.Text) Then
            ...
            ResetYellowColor()
        Else
            'Response.Write("database " & (CDbl(Session("Window_batch")) & "<br>  URL " & CDbl(lblWindowBatch.Text))) : Response.End()
            ClientScript.RegisterClientScriptBlock(Me.GetType, "Check", "<script language='JavaScript'> alert('You have the identical form opened in another browser window.\n\nTo avoid confusion, you are not be permitted to enter information\n in this older version of the form.');</script>")
        End If
    End Sub
    ...
    Protected Sub SendToUpperManager()
        ...
        If CDbl(Trim(lblFIRST_MGT_EMPLID.Text)) - CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) = 0 Then
            ...
            If CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) - CDbl(Trim(lblHR_EMPLID.Text)) = 0 Then
                ...
                SQL1 &= " Update Appraisal_FutureGoals_Master_tbl Set DateSUB_UP_MGT='" & Now & "',DateSUB_HR='" & Now & "',DateHR_Appr='" & Now & "',DateSUB_Empl='" & Now & "' "
                SQL1 &= " where emplid = " & lblEMPLID.Text & " And Perf_Year = " & lblYEAR.Text + 1
                DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
            ...
            Else
                ...
                SQL1 &= " Update Appraisal_FutureGoals_Master_tbl Set DateSUB_UP_MGT='" & Now & "',DateSUB_HR='" & Now & "' where emplid = " & lblEMPLID.Text & " And Perf_Year = " & lblYEAR.Text + 1
                'Response.Write(SQL1) : Response.End()
                DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
                ...
                Msg1 = lblEmpl_NAME.Text & "'s performance appraisal have been completed by " & LblMGT_NAME.Text & " <br><br>"
        ...
        Else
            ...
            If CDbl(Trim(lblFIRST_MGT_EMPLID.Text)) = 6785 Then
            ...
            Else
                ...
                'SQL1 &= " Update Appraisal_FutureGoals_Master_tbl Set DateSUB_UP_MGT='" & Now & "' where emplid = " & lblEMPLID.Text & " And Perf_Year = " & lblYEAR.Text + 1
                'Response.Write(SQL1) : Response.End()
                'DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
    ...
    Protected Sub btnGeneralist_Click(sender As Object, e As EventArgs) Handles btnGeneralist.Click
        ...
        'Response.Write(CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) & " <br>" & CDbl(Trim(lblHR_EMPLID.Text)) & " <br>" & lblMGT_EMPLID.Text) : Response.End()

        If CDbl(Trim(lblSECOND_MGT_EMPLID.Text)) - CDbl(lblHR_EMPLID.Text) = 0 Then
            'Response.Write("1--Appraisal has been Reviewed by HR  Generalist " & lblHR_NAME.Text) : Response.End()
            SQL1 = "Update Appraisal_Master_tbl Set DateSUB_HR='" & Now & "', DateHR_Appr='" & Now & "',Process_Flag=3 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text
            SQL1 &= " Update Appraisal_FutureGoals_Master_tbl Set DateSUB_HR='" & Now & "',DateHR_Appr='" & Now & "' where emplid = " & lblEMPLID.Text & " And Perf_Year = " & lblYEAR.Text + 1
            'Response.Write(SQL1) : Response.End()
            DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
            LocalClass.CloseSQLServerConnection()
        ...
        ElseIf CDbl(Trim(lblHR_EMPLID.Text)) - CDbl(lblMGT_EMPLID.Text) = 0 Then
            'Response.Write("2--Appraisal has been Reviewed by HR  Generalist " & lblHR_NAME.Text) : Response.End()
            SQL1 = "Update Appraisal_Master_tbl Set DateSUB_HR='" & Now & "', DateHR_Appr='" & Now & "',Process_Flag=3 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text
            SQL1 &= " Update Appraisal_FutureGoals_Master_tbl Set DateSUB_HR='" & Now & "',DateHR_Appr='" & Now & "' where emplid = " & lblEMPLID.Text & " And Perf_Year = " & lblYEAR.Text + 1
            'Response.Write(SQL1) : Response.End()
            DT1 = LocalClass.ExecuteSQLDataSet(SQL1)
        ...
        Else
            'Response.Write("3--Appraisal has been Reviewed by HR  Generalist " & lblHR_NAME.Text) : Response.End()
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        If lblEMPLID.Text = 6785 Then
            ...
            SQL &= "DateHR_Appr='" & Now & "',DateEmpl_Appr='" & Now & "',Process_Flag=5 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text
            SQL &= " Update Appraisal_FutureGoals_Master_tbl Set DateHR_Appr='" & Now & "',DateEmpl_Appr='" & Now & "',Process_Flag=5 where emplid=" & lblEMPLID.Text & " and Perf_Year=" & lblYEAR.Text + 1
